...
4. En **`openspec/CHANGES_MAP.md`**: marcá el change como **`[x]`** en *Estado actual*.
5. Consolidá deltas de specs al catálogo si el flujo OPSX del CLI lo requiere (`openspec archive`).
