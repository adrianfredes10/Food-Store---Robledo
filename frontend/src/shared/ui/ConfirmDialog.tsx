  ...
  return (
    <ModalLayer>
      <div
        ...
        aria-modal="true"
      >
        <div className="fade-in max-h-[min(90dvh,100vh)] w-full max-w-md overflow-y-auto overscroll-contain rounded-t-2xl border border-slate-200 bg-white p-5 shadow-lg sm:rounded-lg sm:pb-5 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
